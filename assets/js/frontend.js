        ...
        _createClass(WooVariationGallery, [{
            ...
            value: function initSlick() {
                ...
                this.$slider.on('init', function (event) {
                    ...
                    _this2.$thumbnail.find('.woocommerce-product-gallery__image').not('.slick-slide').removeClass('current-thumbnail');
                    _this2.$thumbnail.find('.woocommerce-product-gallery__image').not('.slick-slide').eq(nextSlide).addClass('current-thumbnail');
                ...
                this.$thumbnail.find('.woocommerce-product-gallery__image').not('.slick-slide').first().addClass('current-thumbnail');

                this.$thumbnail.find('.woocommerce-product-gallery__image').not('.slick-slide').each(function (index, el) {
